...
talk Guest@Shy@Talk
{
	I wonder if she'd notice if I took one of these decorations home...
}
...
talk Guest@Shy@Talk
{
	Maybe if I stand over here, I can just listen and nobody will talk to me.
}
...
talk Guest@Shy@Talk
{
	I think I might be at the wrong party...
}

talk Guest@Shy@Talk
{
	Oh, look, there's a cool bug on the wall...
}

talk Guest@Shy@Talk
{
	Would anyone mind if I took a short nap on the couch...?
}
...
talk Guest@Shy@Talk
{
	I could be at home reading instead...
}


//——————————————— Leaving ———————————————
talk Guest@Shy@Leave
{
...
talk Guest@Shy@Leave
{
	Oh, is it over...? Alright, I'm heading home then, see you...
}
